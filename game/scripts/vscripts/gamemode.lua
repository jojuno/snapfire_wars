...
function GameMode:OnAllPlayersLoaded()
  ...
  GameRules:GetGameModeEntity():SetThink(function ()
    ...
    elseif delta == 9 then
      ...
      for teamNumber in pairs(GameMode.teams) do
        GameMode.numTeams = GameMode.numTeams + 1
      end
      print("[GameMode:OnAllPlayersLoaded] GameMode.numTeams: " .. GameMode.numTeams)
      return 5
...
function GameMode:OnHeroInGame(hero)
  ...
  GameMode.teams[hero:GetTeamNumber()].alive = true
  GameMode.teams[hero:GetTeamNumber()].damageDealt = true
  GameMode.teams[hero:GetTeamNumber()].kills = true
  GameMode.teams[hero:GetTeamNumber()][hero:GetPlayerID()] = {}
  GameMode.teams[hero:GetTeamNumber()][hero:GetPlayerID()]["hero"] = hero
  GameMode.teams[hero:GetTeamNumber()][hero:GetPlayerID()]["hero"].isAlive = true
  GameMode.teams[hero:GetTeamNumber()][hero:GetPlayerID()]["hero"].damageDealt = 0
  GameMode.teams[hero:GetTeamNumber()][hero:GetPlayerID()]["hero"].kills = 0
