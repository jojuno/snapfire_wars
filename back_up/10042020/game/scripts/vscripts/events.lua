...
function GameMode:OnNPCSpawned(keys)
  ...
  print("[GameMode:OnNPCSpawned] npc: ")
  print(npc)
  PrintTable(npc)
  print("[GameMode:OnNPCSpawned] name: " .. npc:GetUnitName())
...
function GameMode:OnEntityKilled( keys )
  ...
  DebugPrintTable( keys )
  --print("[GameMode:OnEntityKilled] function called")
  ...
  if killed_entity_index then
    ...
    --print("[GameMode:OnEntityKilled] killed_unit: ")
    --PrintTable(killed_unit)
  end
  ...
  elseif killed_unit.spawn_name ~= nil and killed_unit.spawn_name == GameMode.mazeTarget.spawn_name then
    --print("[GameMode:OnEntityKilled] maze target died")
    GameMode.mazeTargetKiller = killer_unit
  end
end
