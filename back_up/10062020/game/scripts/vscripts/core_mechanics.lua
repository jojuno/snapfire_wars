                ...
                if teammateAlive then
                    ...
                    for playerID = 0, GameMode.maxNumPlayers do
                        if GameMode.teams[hero:GetTeamNumber()][playerID] ~= nil then
                            ...
                            for i = 0, 10 do
                                print("[GameMode:HeroKilled] this hero's ability at index " .. i .. " is: " .. GameMode.teams[hero:GetTeamNumber()][playerID].hero:GetAbilityByIndex(i):GetAbilityName())
                            end
                            for i = 0, 10 do
                              if GameMode.teams[hero:GetTeamNumber()][playerID].hero:GetModifierNameByIndex(i) then
                                print("[GameMode:HeroKilled] this hero has modifier: " .. GameMode.teams[hero:GetTeamNumber()][playerID].hero:GetModifierNameByIndex(i))
                              end
                            end
                        end
                    end
