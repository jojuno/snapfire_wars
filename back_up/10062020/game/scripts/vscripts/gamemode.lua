...
function GameMode:Restore(hero)
  ...
  hero:Heal(8000, nil)
  hero:GiveMana(8000)
  hero:AddAbility("true_sight")
  --local modifiers = hero:FindAllModifiers()
  for i = 0, 10 do
    if hero:GetModifierNameByIndex(i) then
      print("[GameMode:Restore] this hero has modifier: " .. hero:GetModifierNameByIndex(i))
    end
  end
  ...
  for i = 0, 10 do
    ...
    --print("[GameMode:Restore] modifiers after respawn: ")
